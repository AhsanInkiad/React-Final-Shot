    ...
    return (
        <div className="border m-10 p-5">
            ...
            <div className='flex flex-col justify-center items-center'>
                ...
                <button className='px-3 rounded-lg bg-slate-300' onClick={() => setIsKyle(k => !k)}>Swap</button>
            </div>
            ...
            <div className='flex flex-col justify-center items-center mt-10'>
                ...
                <button className='px-3 rounded-lg bg-slate-300' onClick={() => setIsKyle1(k => !k)}>Swap</button>
            </div>
            ...
            <div className='flex flex-col items-center justify-center mt-10'>
                ...
                <button className='px-3 rounded-lg bg-slate-300' onClick={() => setIsKyle2(k => !k)}>Swap</button>
            </div>
        </div>
    )
}